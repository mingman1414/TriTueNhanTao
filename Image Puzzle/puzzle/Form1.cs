...
namespace WindowsFormsApplication1
{
    public partial class frmPuzzleGame : Form
    {
        ...
        private void KiemTraThoat(object sender, FormClosingEventArgs e)
        {
		...
		{
			KiemTraThoat(sender, e as FormClosingEventArgs);
		}
        ...
        private void btnDiLui_Click(object sender, EventArgs e)
        {
			...
			if(currentState > 0)
			{
				...
				for (int i = 0; i < trt.trangThai.Count; i++)
				{
					((PictureBox)gbKhung.Controls[i]).Image = mangGoc[trt.trangThai[i] - 1];
				}
			}		
		}
